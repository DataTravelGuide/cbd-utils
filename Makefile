...
WARNS := -Wall -Wextra -pedantic -W -Wno-unused-parameter -Wno-unused-variable # -pedantic warns on language standards
...
LIBS := -lsysfs -ljansson # -lm  -I some/path/to/library
